//工点表
	...
	(function() {
							...
							yes: function(index, layero) { //回调
								Mydao.ajax({
									...
									if(result.code == 200) {
										layer.alert("操作成功！");
										//刷新页面
										$("#SupervisoryWorkReport #xmztbg_table3").bootstrapTable("refreshOptions", {
											pageNumber: 1
		...
		$('#SupervisoryWorkReport #xmztbg_table3').bootstrapTable({
			pagination: true,
			...
			queryParams: function(p) {
				...
				Mydao.config.ajaxParams.params.type = 3;
